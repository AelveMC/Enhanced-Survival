...
execute as @e[type=trident] at @s if entity @e[type=guardian,distance=..5] run execute as @e[type=minecraft:guardian,sort=nearest,distance=..5] run data merge entity @s {Tags:["converted"]}
